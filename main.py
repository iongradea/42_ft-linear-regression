...
def main():
    ...
    x_km_norm = normalize_minmax_list(x_km)
    y_price_norm = normalize_minmax_list(y_price)
    print("x_km : {}".format(x_km_norm))
    print("y_price : {}".format(y_price_norm))
    print(type(x_km_norm))
    x_km, _, _ = normalize_zscore_list(x_km)
    y_price, _, _ = normalize_zscore_list(y_price)
    ...
    theta0, theta1, J = gradient_descent(x_km, y_price, 0, 0, 0.1, 100, 0)
